// <copyright file="RibbonPage.RoutedEvents.cs" author="Dmitry Kravchenin" email="d.kravchenin@zaaml.com">
...
namespace Zaaml.UI.Controls.Ribbon
{
  public partial class RibbonPage
  {
    ...
    public static readonly RoutedEvent SelectedEvent = EventManager.RegisterRoutedEvent(nameof(Selected), RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(RibbonPage));
    public static readonly RoutedEvent UnselectedEvent = EventManager.RegisterRoutedEvent(nameof(Unselected), RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(RibbonPage));

// <copyright file="RibbonToggleButton.cs" author="Dmitry Kravchenin" email="d.kravchenin@zaaml.com">
...
{
  public class RibbonToggleButton : RibbonButtonBase, IToggleButton
  {
    #region Static Fields and Constants

    public static readonly DependencyProperty IsCheckedProperty = DPM.Register<bool?, RibbonToggleButton>
      ("IsChecked", false, c => c.UpdateVisualState(true));

    public static readonly DependencyProperty IsThreeStateProperty = DPM.Register<bool, RibbonToggleButton>
      ("IsThreeState");
    ...
    {
      DefaultStyleKeyHelper.OverrideStyleKey<RibbonToggleButton>();
    }

    public RibbonToggleButton()
    {
      this.OverrideStyleKey<RibbonToggleButton>();
    }

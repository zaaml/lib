// <copyright file="ListPropertyInfoDescriptor.cs" author="Dmitry Kravchenin" email="d.kravchenin@zaaml.com">
...
{
	public class ListPropertyInfoDescriptor<TTarget, TCollection, TItem> : CollectionPropertyDescriptor<TTarget, TCollection, TItem> where TCollection : IList<TItem>
	{

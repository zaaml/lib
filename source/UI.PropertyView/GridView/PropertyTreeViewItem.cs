...
namespace Zaaml.UI.Controls.PropertyView
{
	...
	{
		protected PropertyTreeViewItem(PropertyViewControl propertyViewControl)
		{
			PropertyViewControl = propertyViewControl;
		}

		public PropertyViewControl PropertyViewControl { get; }
	}
}
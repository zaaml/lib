...
namespace Zaaml.UI.Controls.Docking
{
  public sealed class FloatLayout : BaseLayout
  {
    ...
    private sealed class FloatLayoutSerializer : LayoutSerializer
    {
      ...
      {
        if (FloatLayoutProperties.Any(l => ShouldSerializeProperty(typeof(FloatLayout), dependencyObject, l)))
        {
          var propertyName = FormatProperty(typeof(FloatLayout), "FloatRect");

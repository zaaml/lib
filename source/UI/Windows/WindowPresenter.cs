...
namespace Zaaml.UI.Windows
{
  ...
  public class WindowContentPresenterTemplateContract : TemplateContract
  {
    #region Properties

    [TemplateContractPart]
    public WindowContentPresenter ContentPresenter { get; [UsedImplicitly] private set; }

    [TemplateContractPart]
    public WindowFooterPresenter FooterPresenter { get; [UsedImplicitly] private set; }

    [TemplateContractPart]
    public WindowFramePresenter FramePresenter { get; [UsedImplicitly] private set; }

    [TemplateContractPart]
    public WindowHeaderPresenter HeaderPresenter { get; [UsedImplicitly] private set; }

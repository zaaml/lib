// <copyright file="ListGridViewCellHeaderAppearance.cs" author="Dmitry Kravchenin" email="d.kravchenin@zaaml.com">
...
{
	public abstract class ListGridViewCellHeaderAppearance : InheritanceContextObject
	{
		private static readonly DependencyPropertyKey ActualGridLinesPropertyKey = DPM.RegisterReadOnly<GridViewLines, ListGridViewCellHeaderAppearance>
		...
		public static readonly DependencyProperty ShowVerticalLinesProperty = DPM.Register<bool, ListGridViewCellHeaderAppearance>
			("ShowVerticalLines", true, d => d.OnShowVerticalLinesPropertyChangedPrivate);

		public static readonly DependencyProperty ShowHorizontalLinesProperty = DPM.Register<bool, ListGridViewCellHeaderAppearance>

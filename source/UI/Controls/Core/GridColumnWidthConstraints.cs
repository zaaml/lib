// <copyright file="GridColumnWidthConstraints.cs" author="Dmitry Kravchenin" email="d.kravchenin@zaaml.com">
...
{
	public readonly struct GridColumnWidthConstraints
	{
		public static GridColumnWidthConstraints Default => new GridColumnWidthConstraints(FlexLength.Star);

		public GridColumnWidthConstraints(FlexLength value, FlexLength minimum, FlexLength maximum)
		{
			Value = value;
			Minimum = minimum;
			Maximum = maximum;
		...
		public GridColumnWidthConstraints(FlexLength value) : this(value, new FlexLength(0), new FlexLength(double.PositiveInfinity))
		{
		}

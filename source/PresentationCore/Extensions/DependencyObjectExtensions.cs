...
namespace Zaaml.PresentationCore.Extensions
{
	internal static class DependencyObjectExtensions
	{
		...
		public static void EnsureBindingSet(this DependencyObject depObj, DependencyProperty depProp, Binding binding)
		{
			BindingUtil.EnsureBindingSet(depObj, depProp, binding);
		}

		public static void EnsureValueSet<T>(this DependencyObject depObj, DependencyProperty depProp, T value)
		{
